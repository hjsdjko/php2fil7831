        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"cursor":"pointer","padding":"0 0px 0 0px","boxShadow":"inset 0px 0px 0px 0px rgba(244,100,130,.3)","margin":"0 10px 5px 0","borderColor":"rgba(244,111,139,.3)","color":"#555","minWidth":"40px","outline":"none","borderRadius":"0px","background":"rgba(255,255,255,.0)","borderWidth":"0 0 4px","width":"auto","fontSize":"14px","lineHeight":"32px","borderStyle":"double","height":"32px"}'
                size="small"
