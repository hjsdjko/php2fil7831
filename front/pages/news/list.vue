		...
		<view :style='{"minHeight":"100vh","padding":"0","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"block","width":"100%","position":"relative","height":"auto"}'>
			<view class="cu-bar bg-white search" :style='{"padding":"20rpx 24rpx 20rpx 0","margin":"0 0 0 auto","background":"#fff","display":"flex","width":"calc(100% - 0px)","height":"auto","order":"0"}'>
				...
				<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' v-if="queryIndex==0" class="search-form round">
					...
					<input :style='{"border":"2rpx solid #FC6103","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"40rpx","background":"#f7f7f7","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
				</view>
			...
			<view :style='{"margin":"0px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto","order":"3"}'>
				...
				<view id="news-list-7" class="news-box7 waterfall-body" :style='{"padding":"20rpx 24rpx 0","alignItems":"flex-start","background":"#f7f7f7","display":"flex","width":"calc(100% - 128rpx)","height":"auto","order":"5"}'>
					<view id="waterfall-left-column-news-7" class="waterfall-column-news-7" :style='{"margin":"0 12rpx 0 0","flex":"1","flexDirection":"column","display":"flex"}'>
						<view @tap="onDetailTap(product)" :style='{"boxShadow":"0 2rpx 16rpx rgba(0,0,0,.3)","margin":"0 0 20rpx 0","overflow":"hidden","position":"relative","borderRadius":"12rpx"}' v-for="product in leftListNews7" :key="product.id" class="left-content">
							...
							<view :style='{"left":"0","flexWrap":"wrap","background":"rgba(0,0,0,.3)","bottom":"0","display":"flex","width":"100%","position":"absolute"}'>
								<view :style='{"padding":"0 20rpx","whiteSpace":"nowrap","overflow":"hidden","color":"#fff","width":"100%","lineHeight":"1.5","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
								...
								<view :style='{"width":"50%","padding":"0 20rpx","display":"inline-block"}'>
