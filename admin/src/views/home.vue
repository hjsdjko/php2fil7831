<template>
<div class="content" :style='{"minHeight":"100vh","padding":"0px 20px 180px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230804/6bc6f4062ebb4bd1925b0666272402fb.jpg) no-repeat center bottom / cover","display":"flex","fontSize":"16px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
...
<style lang="scss" scoped>
	...
	// echarts1
	.type1 .echarts1 {
				border: 6px double rgba(244,111,139,.1);
				border-radius: 20px;
				padding: 10px;
				margin: 0px 0;
