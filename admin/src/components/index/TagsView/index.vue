<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0px 30px 0px 250px","boxShadow":"none","margin":"5px auto","borderColor":"#ed5474","overflow":"hidden","top":"80px","borderRadius":"60px","left":"30px","background":"linear-gradient(180deg, rgba(254,184,197,1) 0%, rgba(244,111,139,1) 100%)","borderWidth":"0px","width":"calc(100% - 60px)","fontSize":"16px","lineHeight":"35px","position":"fixed","borderStyle":"solid","height":"35px","zIndex":"999"}'>
