<template>
  <div class="main-content" :style='{"padding":"20px 30px 30px","fontSize":"14px","color":"#666","background":"none","height":"100%"}'>
    <!-- 列表页 -->
    <div v-if="!showFlag">
      <el-form :style='{"border":"1px solid rgba(255,255,255,1)","padding":"30px","borderColor":"#fceaee","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"rgba(255,255,255,1)","borderWidth":"6px","display":"flex","fontSize":"inherit","borderStyle":"double"}' :inline="true" :model="searchForm" class="add-update-preview">
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="试卷">
          <el-input v-model="searchForm.papername" placeholder="试卷名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="试题">
          <el-input v-model="searchForm.questionname" placeholder="试题名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'>
