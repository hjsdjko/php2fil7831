	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
            <view :style='{"padding":"24rpx","margin":"-60rpx 0 0","borderRadius":"60rpx 60rpx 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"auto","zIndex":"999"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"margin":"0 0 24rpx 0","borderColor":"#D8D8D8","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view :style='{"margin":"0 auto 24rpx 0","borderColor":"#ccc","borderRadius":"40rpx","alignItems":"center","textAlign":"center","borderWidth":"0","background":"#FC6103","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#fff","textAlign":"right"}' class="lable">赞：</view>
					<view :style='{"width":"auto","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"width":"auto","lineHeight":"60rpx","fontSize":"28rpx","color":"#fff"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
					</view>
				</view>
				<view :style='{"margin":"0 auto 24rpx 0","borderColor":"#ccc","borderRadius":"40rpx","alignItems":"center","textAlign":"center","borderWidth":"0","background":"#FC6103","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#fff","textAlign":"right"}' class="lable">已赞：</view>
					<view :style='{"width":"auto","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"width":"auto","lineHeight":"60rpx","fontSize":"28rpx","color":"#fff"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
					</view>
				</view>
				<view :style='{"margin":"0 0 24rpx auto","borderColor":"#C4C4C4","borderRadius":"40rpx","alignItems":"center","borderWidth":"2rpx","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#C4C4C4","textAlign":"right"}' class="lable">踩：</view>
					<view :style='{"width":"auto","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"color":"#C4C4C4","lineHeight":"60rpx","fontSize":"28rpx"}'>{{detail.crazilynum}}</view>
				...
				<view :style='{"margin":"0 0 24rpx auto","borderColor":"#C4C4C4","borderRadius":"40rpx","alignItems":"center","borderWidth":"2rpx","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","justifyContent":"center","height":"auto"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#C4C4C4","textAlign":"right"}' class="lable">踩：</view>
					<view :style='{"width":"auto","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"color":"#C4C4C4","lineHeight":"60rpx","fontSize":"28rpx"}'>{{detail.crazilynum}}</view>
						<view style="transform: rotate(180deg);" :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
