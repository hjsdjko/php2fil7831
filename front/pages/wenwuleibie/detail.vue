	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('wenwuleibie', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','wenwuleibie');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				uni.setStorageSync('crossTable','wenwuleibie');
			...
			async init(){
				...
				let res = await this.$api.info('wenwuleibie', this.id);
				this.detail = res.data;
