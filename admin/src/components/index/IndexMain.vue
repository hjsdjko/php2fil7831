<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"118px 0 0 96px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/91393801161b4cacb43c84eeacd8f7d0.gif),#fff","display":"block"} : {"minHeight":"100%","padding":"118px 0 0 260px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20230807/91393801161b4cacb43c84eeacd8f7d0.gif),#fff","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 0px rgba(3, 152, 15, .05)","padding":"8px 190px 8px 280px","margin":"0 auto","borderColor":"#f6dce0","alignItems":"center","color":"#333","display":"flex","justifyContent":"space-between","top":"0","left":"0","background":"url(http://codegen.caihongy.cn/20230803/8bdcbc8150c94beeb1ee0d0a2d8d3a63.jpg) no-repeat center top /cover","borderWidth":"0 0 1px","width":"calc(100% - 0px)","fontSize":"16px","position":"fixed","borderStyle":"solid","zIndex":"999","height":"80px"}'></index-header>
